# dekomponoidaan muuttoaikasarja muuton tyollisten ja työttömien jälkseien ptoim1 mukaan
   library(tidyverse)
   library(ggplot2)
...
ggsave("W:/Liikkuvuusvalinnat/Output_files/migration_timeseries/muutot_tyolliset_tyottomat_ptoim1_muuton_jalkeen/kuntien_valiset_tyolliset.png")
...
ggsave("W:/Liikkuvuusvalinnat/Output_files/migration_timeseries/muutot_tyolliset_tyottomat_ptoim1_muuton_jalkeen/kuntien_valiset_tyottomat.png")
...
ggsave("W:/Liikkuvuusvalinnat/Output_files/migration_timeseries/muutot_ptoim1_ennen_muuttoa/seutukuntien_valiset_muuttajat_ptoim1_ennen_muuttoa.png")
...
ggsave("W:/Liikkuvuusvalinnat/Output_files/migration_timeseries/muutot_ptoim1_ennen_muuttoa/maakuntien_valiset_muuttajat_ptoim1_ennen_muuttoa.png")
