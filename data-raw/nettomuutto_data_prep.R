...
nettomuutto_data$Alue <- as.character(nettomuutto_data$Alue)
nettomuutto_data$Alue[nettomuutto_data$Alue == "Maarianhamina - Mariehamn"] <- "Maarianhamina"

nettomuutto_data <- nettomuutto_data %>% select(-Tiedot, - Ikä, -Sukupuoli) %>%
...
# Save data
   saveRDS(nettomuutto_data, file = "R/data_clean/nettomuutto_data.rds")
